<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="socialtrade.Index1" %>
    ...
    <section id="Section1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div id="Div1">
                        <form id="Form1" class="contact" name="contact-form" method="post" action="send-mail.php">
